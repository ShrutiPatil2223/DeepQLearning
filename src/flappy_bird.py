# -*- coding: utf-8 -*-
"""
Created on Sun Jan 14 18:39:08 2024
...
class FlappyBird(object):
    ...
    base_image = load('C:/Users/shrut/Downloads/base.png').convert_alpha()
    background_image = load('C:/Users/shrut/Downloads/background-black.png').convert()

    pipe_images = [rotate(load('C:/Users/shrut/Downloads/pipe-green.png').convert_alpha(), 180),
                   load('C:/Users/shrut/Downloads/pipe-green.png').convert_alpha()]
    bird_images = [load('C:/Users/shrut/Downloads/redbird-upflap.png').convert_alpha(),
                   load('C:/Users/shrut/Downloads/redbird-midflap.png').convert_alpha(),
                   load('C:/Users/shrut/Downloads/redbird-downflap.png').convert_alpha()]
